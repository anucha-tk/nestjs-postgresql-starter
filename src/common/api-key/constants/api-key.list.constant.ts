...
export const API_KEY_DEFAULT_ORDER_BY = "id";
export const API_KEY_DEFAULT_ORDER_DIRECTION = ENUM_PAGINATION_ORDER_DIRECTION_TYPE.DESC;
export const API_KEY_DEFAULT_AVAILABLE_ORDER_BY = ["id", "name", "key", "createdAt"];
