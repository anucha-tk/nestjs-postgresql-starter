...
export class PermissionSerialization extends ResponseIdSerialization {
  @ApiProperty({
    required: true,
    nullable: false,
  ...
  @ApiProperty({
    ...
    example: faker.helpers.arrayElement(Object.values(ENUM_POLICY_ACTION)),
  })
...
export class RoleGetSerialization extends ResponseIdSerialization {
  ...
  @ApiProperty({ required: false, nullable: true, type: [PermissionSerialization] })
  @Type(() => PermissionSerialization)
  permissions: PermissionSerialization[];
