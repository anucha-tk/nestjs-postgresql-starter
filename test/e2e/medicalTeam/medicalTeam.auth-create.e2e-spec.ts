...
describe("medicalTeam auth create e2e", () => {
  const MEDICALTEAM_CREATE_URL = "/auth/medicalTeam/create";
  ...
  describe("Auth", () => {
    ...
    describe("validation body", () => {
      ...
      it("should return 404 when customerId notfound", async () => {
        const dto = {
          name: "Mattie",
          type: "staff",
          phones: [
      ...
      it("should return 422 when phoneNumber invalid", async () => {
        const dto = {
          name: "Mattie",
          type: "staff",
          phones: [
    ...
    describe("response", () => {
      it("should return 201 and id when create success", async () => {
        const dto = {
          name: "Mattie",
          type: "staff",
          phones: [
